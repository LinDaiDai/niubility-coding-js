...
在HTTPS加密传输中，实际上涉及到 SSL/TLS 协议，这里是有一个TLS握手的过程。对于传统的TLS握手也就是RSA握手我就不描述了，主要是说一下现在主流的TLS1.2版本的握手，也就是ECDHE握手。
...
### 13. 那你知道TLS1.3版本吗？它较TLS1.2做了哪些改进呢？

TLS1.3版本是2018年推出的。它较TLS1.2主要是做了以下改进：
